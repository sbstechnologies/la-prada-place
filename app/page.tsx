...
export default function Home() {
  ...
  const getAmenityDescription = (title = "") => {
    const descriptions: Record<string, string> = {
      "Enclosed Sunroom & Patio Lounge":
        "Relax and enjoy extra living space in an enclosed sunroom and patio lounge, perfect for unwinding, entertaining, or enjoying the outdoors in comfort.",

      "Gated Limited-Access Entry":
        "Enjoy added peace of mind with gated, limited-access entry designed to provide residents with a more private and secure community environment.",

      "Resident Clubhouse & Coffee Bar":
        "Gather, relax, and connect with neighbors in the welcoming resident clubhouse and coffee bar, a comfortable space for socializing and everyday enjoyment.",

      "Swimming Pool & Hot Tub":
        "Unwind and refresh at the swimming pool and hot tub, offering inviting spaces to relax, soak, and enjoy leisurely days close to home.",

      "Townhouse-Style Living":
        "Experience the comfort and character of townhouse-style living with spacious layouts designed to provide a welcoming sense of privacy and home.",

      "Covered Carports & Private Garages":
        "Enjoy convenient parking options with covered carports and private garages, providing added protection and easy access close to your home.",
    };
          ...
          >
            ...
            <div className="mb-8 flex items-center gap-4 w-full max-w-[900px] justify-center">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#F5F2ED]/50">
                La Prada Place Apartment Homes • Dallas, TX• NOW LEASING
              </span>
              <div className="h-px flex-1 max-w-[72px] bg-[#F5F2ED]/15" />
            </div>
            ...
            <p className="text-[clamp(12px,1.3vw,15px)] leading-[1.55] text-[#F5F2ED]/70 mb-10 max-w-[800px]">
              A gated community offering spacious 768–1,053 sq ft one,
              two-bedroom, and townhome-style residences featuring upgraded
              interiors, resort-style amenities, and effortless 15-minute
              connectivity to Downtown Dallas.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-14 mb-10 md:mb-12">
            ...
            <div className="md:flex md:items-center">
              <p className="font-[Plus_Jakarta_Sans] text-[15px] sm:text-[16px] md:text-[19px] leading-[1.75] text-[#9faac0] max-w-xxl">
                ...
                the enclosed sunroom patio, or take advantage of our gated
                community access and dedicated covered parking.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-[1920px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 xl:gap-28 items-center">
          ...
          <div className="lg:pl-8 xl:pl-12">
            <p className="font-[Plus_Jakarta_Sans] text-sm md:text-base text-[#5a6260] text-justify leading-relaxed max-w-xxl">
              La Prada Place places you in a connected East Dallas location
              surrounded by convenient shopping centers, neighborhood parks, and
              premier dining destinations. Enjoy effortless commutes with
              instant access to I-30, Highway 80, and I-635, placing Downtown
              Dallas and Dallas College Eastfield Campus just minutes away.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 md:px-[5.56vw] relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-3.5 flex-wrap mb-10 sm:mb-12 px-4 sm:px-0">
            <a
              ...
              className="flex items-center justify-center gap-2 px-6 sm:px-8 md:px-9 py-3.5 sm:py-4 md:py-[15px] rounded-full bg-[#1e3872] text-[#f5f2ed] font-[Plus_Jakarta_Sans] text-[13px] sm:text-[14px] md:text-[15px] font-bold cursor-pointer shadow-[rgba(30,56,114,0.5)_0px_4px_24px] tracking-[0.01em] border-none outline-none hover:opacity-95 transition-opacity whitespace-nowrap"
            >
              Apply Now
              <svg
                xmlns="http://www.w3.org/2000/svg"
