...
function getFloorPlanAlt(plan: FloorPlan): string {
  ...
  if (title.includes("a1")) {
    return "Plan A1 one bedroom apartment floor plan at La Prada Place Apartment Homes";
  }

  if (title.includes("a2")) {
    return "Plan A2 one bedroom apartment floor plan at La Prada Place Apartment Homes";
  }
