...
export async function POST(req: Request) {
  ...
  >
     ...
     <div style="background:#111827;padding:24px;text-align:center;color:#9ca3af;font-size:13px;">
              ...
              <div style="margin-top:8px;">
                8383 La Prada Dr, Dallas, TX 75228
              </div>
              ...
              <div style="margin-top:15px;">
                ...
                La Prada Place Apartment Homes website contact form.
              </div>
