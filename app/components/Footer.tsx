          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mb-6">
                <span className="flex h-[38px] w-[38px] shrink-0 items-center justify-center overflow-hidden rounded-[12px] bg-[var(--primary)]">
                  <Image
              ...
              <p className="text-[15px] leading-[1.9] text-[#8e99ad] mb-8 font-[Plus_Jakarta_Sans]">
                Thoughtfully designed apartment homes and lush community
                amenities crafted for comfortable, connected living in Dallas,
                TX.
              </p>
